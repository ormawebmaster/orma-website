...
import { ArrowLeft, CheckCircle2, MapPin, Send, Briefcase } from 'lucide-react';
...
const JobDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header Immersif */}
      <div className="bg-gray-950 text-white pt-10 pb-32 px-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-[#CC2128]/10 blur-[100px] rounded-full" />

        <div className="max-w-5xl mx-auto relative z-10">
          <div className="flex justify-between items-center mb-16">
            <Link to="/" className="inline-flex items-center text-gray-500 hover:text-white transition-colors text-[10px] font-black uppercase tracking-widest">
              <ArrowLeft className="mr-2 w-4 h-4" /> Retour accueil
            </Link>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-7xl font-black leading-none tracking-tighter uppercase">{job.title}</h1>
            </div>

            <a
              href={`mailto:info@orma.ch?subject=Candidature pour le poste de ${job.title}`}
              className="px-10 py-5 bg-white text-black rounded-2xl font-black text-lg hover:bg-gray-100 transition-all shadow-2xl flex items-center justify-center whitespace-nowrap"
            >
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-16 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 rounded-[32px] p-10 border border-gray-100 sticky top-12">
