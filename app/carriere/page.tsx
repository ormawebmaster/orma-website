        ...
        <div className="flex flex-col bg-white overflow-x-hidden">
            ...
            <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-6 overflow-hidden py-24 md:py-32">
                ...
                <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center justify-center gap-12 md:gap-20 z-10">
                    ...
                    <div className="flex-1 flex justify-center order-2 w-full max-w-[280px] sm:max-w-[340px] lg:max-w-[400px]">
                        <div className="relative w-full aspect-[9/17] bg-[#111] rounded-[40px] md:rounded-[50px] border-[6px] md:border-[10px] border-gray-900 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden">
