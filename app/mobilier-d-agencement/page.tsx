...
import { MobilierHero } from "@/components/mobilier-hero"
...
const services = [
  ...
  },
  {
    ...
    description: "Des solutions personnalisées pour répondre à vos besoins uniques. Chaque projet est conçu sur-mesure selon vos spécifications exactes.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-left mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl">
              Découvrez les trois piliers de notre savoir-faire en mobilier et agencement
            </p>
          </div>
