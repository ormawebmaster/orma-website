...
export function NavbarDark() {
    ...
    return (
        <nav className="fixed top-4 left-4 right-4 z-50 px-6 md:px-12 lg:px-16 py-4 bg-[#335c67] dark:bg-white rounded-full shadow-sm">
                    ...
                    <div onMouseEnter={() => setManufactureMenuOpen(true)} onMouseLeave={() => setManufactureMenuOpen(false)}>
                        <DropdownMenu open={manufactureMenuOpen} onOpenChange={setManufactureMenuOpen}>
                            <DropdownMenuTrigger asChild>
                                <Link href="/savoir-faire-et-fabrication" className="flex items-center gap-1 text-white dark:text-gray-700 hover:text-gray-200 dark:hover:text-gray-900 transition-colors text-sm focus:outline-none">
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="lg:hidden absolute top-full left-0 right-0 mt-2 mx-4 bg-[#335c67] dark:bg-white shadow-lg rounded-2xl py-4 px-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent className="pl-4 text-white/80 dark:text-gray-600">
                                    ...
                                    <div className="py-2">
                                        <Link href="/expertises" className="font-semibold text-white dark:text-gray-800 block hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Expertises</Link>
                            ...
                            <AccordionItem value="item-2">
                                ...
                                <AccordionContent className="pl-4 text-white/80 dark:text-gray-600">
                                    <Link href="/mobilier-methode-de-fonctionnement" className="block py-2 hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Notre approche</Link>
                                    <div className="py-2">
                                        <Link href="/mobilier-domaines-de-competence" className="font-semibold text-white dark:text-gray-800 block hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Expertises</Link>
                                        <div className="pl-4 mt-1">
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent className="pl-4 text-white/80 dark:text-gray-600">
                                    <Link href="/planification-dao" className="block px-4 py-2 hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Conception & Planification</Link>
                                    <Link href="/livraison-installation" className="block px-4 py-2 hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Livraison & Installation (world wide)</Link>
                                    ...
                                    <Link href="/coaching-formations" className="block px-4 py-2 hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Conseil & Formation</Link>
                                    <Link href="/sourcing" className="block px-4 py-2 hover:text-white dark:hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Sélection & Sourcing</Link>
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
                        <Link
