                        ...
                        <div onMouseEnter={() => setManufactureMenuOpen(true)} onMouseLeave={() => setManufactureMenuOpen(false)}>
                            <DropdownMenu open={manufactureMenuOpen} onOpenChange={setManufactureMenuOpen}>
                                <DropdownMenuTrigger asChild>
                                    <Link href="/savoir-faire-et-fabrication" className="flex items-center gap-1 text-gray-700 dark:text-white hover:text-gray-900 dark:hover:text-gray-200 transition-colors text-sm focus:outline-none">
                                ...
                                <DropdownMenuContent className="bg-white dark:bg-[#335c67] text-gray-800 dark:text-white p-2 rounded-md shadow-lg">
                                    <DropdownMenuItem asChild>
                                        <Link href="/Notre-approche" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-md">
                                            Notre approche
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuSub>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="item-1">
                                    ...
                                    <AccordionContent className="pl-4 text-gray-600 dark:text-white/80">
                                        ...
                                        <div className="py-2">
                                            <Link href="/expertises" className="font-semibold text-gray-800 dark:text-white block hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Expertises</Link>
                                ...
                                <AccordionItem value="item-2">
                                    ...
                                    <AccordionContent className="pl-4 text-gray-600 dark:text-white/80">
                                        ...
                                        <div className="py-2">
                                            <Link href="/mobilier-domaines-de-competence" className="font-semibold text-gray-800 dark:text-white block hover:text-gray-900" onClick={() => setIsMenuOpen(false)}>Expertises</Link>
                                            <div className="pl-4 mt-1">
