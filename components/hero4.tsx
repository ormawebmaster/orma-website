...
import { NavbarWithTopBar } from "@/components/navbar-topbar"
...
export function Hero4() {
    ...
    return (
        <section className="relative h-screen overflow-hidden">
            ...
            {/* Hero Content */}
            <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 md:px-12 lg:px-20 max-w-4xl pt-24">
